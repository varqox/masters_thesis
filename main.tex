...
The plots illustrate the distribution of the measured times i.e. distribution of values $x_1, \ldots, x_{10}$ for each configuration. Elements of the plots are described in the Figure~\ref{figure:plot_legend}. The x-axis is logarithmic to better illustrate both small values and large values and differences between similar values on a single plot. This is not ideal but helps considerably.
